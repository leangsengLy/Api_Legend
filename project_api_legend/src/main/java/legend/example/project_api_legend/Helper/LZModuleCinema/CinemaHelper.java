...
public class CinemaHelper {
    ...
    public static class Url {
        public final static String List = "api/cinema/list"; 
        public final static String Create = "api/cinema/create"; 
        ...
        public final static String CheckCode = "api/cinema/check_code"; 
   }
}
